# Procedure de gestion des incidents et cadre de conduite des projets applicatifs
...
Ce document rassemble les regles operationnelles de declaration, de qualification et de resolution des incidents, ainsi que les exigences minimales appliquees aux projets applicatifs menes par la DSI. Il permet d'assurer une exploitation coherente tout en securisant l'introduction de nouvelles solutions dans le SI hospitalier.

## Corps principal

Finalite. La procedure de gestion des incidents a pour but de retablir le service dans les meilleurs delais tout en preservant la qualite de l'information transmise aux utilisateurs et aux responsables. Le cadre projet, quant a lui, vise a faire entrer en production des solutions conformes aux exigences d'exploitation, de securite, de capacite et de support.

Declaration. Tout incident peut etre declare par le centre de services, par la supervision ou par une equipe technique. La declaration doit au minimum contenir l'heure de debut observee, le service impacte, les symptomes constates, le nombre d'utilisateurs touches, le niveau d'urgence pressenti et les actions deja tentees.

Qualification. L'incident est qualifie selon sa criticite, son etendue, son caractere repetitif et son impact sur les soins ou sur les fonctions support essentielles. Cette qualification determine le delai de prise en charge, le niveau d'escalade, la frequence des points de situation et la necessite eventuelle d'ouvrir une cellule de coordination.

Escalade. Lorsque l'incident depasse les capacites du support de premier niveau ou engage un risque fort pour la continuite d'activite, il est escalade vers l'equipe competente avec un dossier deja structure. Les escalades vers les editeurs ou les integrateurs doivent comporter des elements factuels exploitables, notamment journaux, horodatages et captures des erreurs significatives.

Communication. La communication d'incident doit etre differenciee selon les publics concernes. Les utilisateurs ont besoin d'un message court, stable et operationnel, tandis que les responsables de domaine attendent une estimation des impacts, des dependances connues, des mesures de contournement et de l'heure previsionnelle du prochain point.

Resolution et cloture. Un incident ne peut etre cloture qu'apres verification du retour a un fonctionnement acceptable et, si pertinent, apres confirmation du metier. La fiche de cloture documente la cause immediate, les actions menees, la presence ou non d'une dette technique et la decision d'ouvrir un probleme lorsque la recurrence ou la cause racine le justifie.

Gestion des problemes. Les incidents repetitifs, majeurs ou mal expliques doivent donner lieu a une analyse de probleme. Cette analyse ne se limite pas au composant en defaut apparent et cherche a identifier les facteurs structurels, tels qu'une architecture fragile, une supervision insuffisante, une documentation incomplete ou une pratique d'administration inadaptee.

Portefeuille projets. Les projets applicatifs sont instruits selon une priorisation partagee entre besoins metier, contraintes reglementaires, obsolescence technique et capacite de la DSI. Tout projet entrant au portefeuille doit disposer d'un sponsor, d'un responsable cote metier, d'un referent DSI et d'une expression de besoin suffisamment explicite pour permettre un cadrage realiste.

Cadrage. Le cadrage projet comprend au minimum les objectifs fonctionnels, le perimetre, les interfaces, les pre requis techniques, les hypotheses de charge, les exigences de securite, les besoins de support et les impacts sur l'infrastructure existante. L'absence de cadrage sur ces points expose a des retards, a des couts de reprise et a une qualite d'exploitation insuffisante.

Exigences d'exploitation. Avant mise en production, chaque projet doit fournir son dossier d'exploitation comprenant architecture, flux, comptes de service, sauvegardes, supervision, procedures de demarrage et d'arret, contacts de support et modalites d'escalade editeur. Sans ce dossier, la mise en service est reportee, sauf arbitrage formel motive par une contrainte imperieuse.

Recette et mise en production. La recette doit couvrir les cas fonctionnels majeurs, la robustesse des flux, les habilitations, la journalisation des actions sensibles et les scenarios de reprise simples. La mise en production est precedee d'une revue go ou no go qui verifie la disponibilite des equipes, le plan de retour arriere et la coherence entre documentation, parametres et version livree.

Suivi post-demarrage. Les trente premiers jours suivant le demarrage font l'objet d'un suivi renforce avec indicateurs de stabilite, analyse des demandes d'assistance et revue des incidents. Cette phase permet de distinguer les ajustements normaux de demarrage des anomalies structurelles et d'alimenter un plan d'actions cible avant passage en regime nominal.

## Reperes operationnels

Repere 1. Dans le cadre incident de production, le role responsable infrastructure doit relire les hypotheses relatives a Architecture technique et urbanisation du SI avant toute validation definitive. Pour le groupe dsi, la documentation associee a "Procedure de gestion des incidents et cadre de conduite des projets applicatifs" rappelle que la qualite d'execution depend autant de la clarte des responsabilites que de la precision des informations transmises. Lorsque la situation change, la mise a jour doit etre horodatee, motivee et reliee a un indicateur de suivi tel que RTO observe. Cette discipline documentaire permet de retrouver rapidement les passages utiles a une question RAG portant sur architecture, sur les arbitrages de terrain et sur les suites a donner.

Repere 2. Dans le cadre mise en production, le role ingenieur systeme doit relire les hypotheses relatives a Supervision, observabilite et capacite avant toute validation definitive. Pour le groupe dsi, la documentation associee a "Procedure de gestion des incidents et cadre de conduite des projets applicatifs" rappelle que la qualite d'execution depend autant de la clarte des responsabilites que de la precision des informations transmises. Lorsque la situation change, la mise a jour doit etre horodatee, motivee et reliee a un indicateur de suivi tel que RPO respecte. Cette discipline documentaire permet de retrouver rapidement les passages utiles a une question RAG portant sur supervision, sur les arbitrages de terrain et sur les suites a donner.

Repere 3. Dans le cadre test de restauration, le role RSSI doit relire les hypotheses relatives a Sauvegardes, retention et restauration avant toute validation definitive. Pour le groupe dsi, la documentation associee a "Procedure de gestion des incidents et cadre de conduite des projets applicatifs" rappelle que la qualite d'execution depend autant de la clarte des responsabilites que de la precision des informations transmises. Lorsque la situation change, la mise a jour doit etre horodatee, motivee et reliee a un indicateur de suivi tel que taux de patching. Cette discipline documentaire permet de retrouver rapidement les passages utiles a une question RAG portant sur sauvegardes, sur les arbitrages de terrain et sur les suites a donner.

Repere 4. Dans le cadre revue IAM, le role architecte SI doit relire les hypotheses relatives a IAM, habilitations et tracabilite avant toute validation definitive. Pour le groupe dsi, la documentation associee a "Procedure de gestion des incidents et cadre de conduite des projets applicatifs" rappelle que la qualite d'execution depend autant de la clarte des responsabilites que de la precision des informations transmises. Lorsque la situation change, la mise a jour doit etre horodatee, motivee et reliee a un indicateur de suivi tel que delai moyen de resolution. Cette discipline documentaire permet de retrouver rapidement les passages utiles a une question RAG portant sur IAM, sur les arbitrages de terrain et sur les suites a donner.

Repere 5. Dans le cadre segmentation reseau, le role technicien support doit relire les hypotheses relatives a Gestion des incidents et escalade avant toute validation definitive. Pour le groupe dsi, la documentation associee a "Procedure de gestion des incidents et cadre de conduite des projets applicatifs" rappelle que la qualite d'execution depend autant de la clarte des responsabilites que de la precision des informations transmises. Lorsque la situation change, la mise a jour doit etre horodatee, motivee et reliee a un indicateur de suivi tel que couverture de supervision. Cette discipline documentaire permet de retrouver rapidement les passages utiles a une question RAG portant sur segmentation reseau, sur les arbitrages de terrain et sur les suites a donner.
