# Referentiel d'architecture technique et de supervision du SI hospitalier
...
Ce document decrit l'architecture cible du systeme d'information, les principes d'hebergement, les dependances critiques et l'organisation de la supervision pour les services supports et les applications de soins. Il sert de base commune pour l'exploitation, la capacite, l'analyse des incidents et la preparation des changements.

## Corps principal

Perimetre. Le present referentiel couvre les environnements de production, de preproduction et d'administration exploites par la DSI pour les applications administratives, medico-techniques et cliniques. Les composants recenses incluent les serveurs applicatifs, les bases de donnees, les passerelles d'interconnexion, les services de fichiers, les equipements reseau utiles a l'hebergement et les briques de supervision.

Principe d'architecture. L'architecture est organisee selon un modele en couches comprenant acces utilisateur, services applicatifs, integration, donnees et socle d'infrastructure. Cette separation vise a limiter les dependances directes entre applications, a favoriser la maintenance et a permettre des plans de reprise gradues selon la criticite metier.

Hebergement. Les charges principales sont hebergees sur une infrastructure virtualisee repartie sur deux salles techniques distinctes au sein de l'etablissement. Les applications a criticite elevee disposent d'une redondance active ou d'une capacite de bascule rapide, tandis que les services non critiques restent sur une infrastructure mutualisee avec fenetres de maintenance planifiees.

Socle systeme. Les systemes d'exploitation supportes sont standardises par famille de service afin de reduire la dispersion technique. Chaque image de reference integre les parametres de journalisation, l'agent de supervision, la configuration NTP, les regles de durcissement de base et le raccordement aux services d'authentification de l'etablissement.

Flux inter-applicatifs. Les echanges entre applications s'appuient prioritairement sur des API internes ou des mecanismes de mediation traces. Les flux historiques par partage de fichiers ou depots SFTP restent autorises lorsqu'une contrainte editeur l'impose, sous reserve de journalisation, de controle des droits d'acces et de revue periodique des traitements.

Supervision technique. La supervision technique couvre la disponibilite des hotes, l'etat des services, la charge CPU, la saturation memoire, l'espace disque, l'etat des sauvegardes, la latence applicative et l'occupation des bases. Les seuils sont definis par criticite, avec une distinction entre alerte informative, alerte d'exploitation et incident majeur.

Supervision applicative. Pour les applications critiques, la supervision ne se limite pas au ping ou au statut du service. Des controles de bout en bout verifient l'ouverture de session, l'acces a une fonctionnalite representative, la reponse d'une base de donnees et, lorsque cela est possible, la presence de flux entrants et sortants dans des volumes attendus.

Journaux et traces. Les journaux systeme et applicatifs sont centralises afin de faciliter les analyses transverses et la detection des signaux faibles. Les durees de conservation sont alignees sur les besoins d'exploitation et les exigences de tracabilite, avec un cloisonnement des acces aux traces contenant des donnees potentiellement sensibles.

Capacite. La revue de capacite est conduite mensuellement pour les plateformes principales et avant tout projet susceptible d'augmenter la charge. Les indicateurs suivis portent notamment sur l'evolution des volumetries de donnees, les pics de connexion, les temps de reponse, l'usage du stockage et la marge de croissance disponible a trois et six mois.

Changements. Toute modification d'architecture, de parametre de supervision ou de topologie d'hebergement fait l'objet d'une demande de changement documentee. Le dossier precise le perimetre, les impacts attendus, la fenetre d'intervention, les verifications avant et apres changement ainsi que les conditions de retour arriere.

Responsabilites. L'equipe infrastructure porte la responsabilite du socle, du reseau de datacenter, de la virtualisation et de la supervision transverse. Les referents applicatifs sont responsables des controles metier, de la qualification des alertes propres a leur domaine et de la priorisation des remediations en lien avec les utilisateurs metier.

Revision du referentiel. Le referentiel est revu au minimum tous les six mois et apres chaque incident majeur affectant la disponibilite ou la capacite. Les ecarts constates entre architecture documentee et architecture observee doivent etre regularises dans un delai de trente jours ouvrés, avec arbitrage du responsable exploitation si necessaire.

## Reperes operationnels

Repere 1. Dans le cadre incident de production, le role responsable infrastructure doit relire les hypotheses relatives a Architecture technique et urbanisation du SI avant toute validation definitive. Pour le groupe dsi, la documentation associee a "Referentiel d'architecture technique et de supervision du SI hospitalier" rappelle que la qualite d'execution depend autant de la clarte des responsabilites que de la precision des informations transmises. Lorsque la situation change, la mise a jour doit etre horodatee, motivee et reliee a un indicateur de suivi tel que RTO observe. Cette discipline documentaire permet de retrouver rapidement les passages utiles a une question RAG portant sur architecture, sur les arbitrages de terrain et sur les suites a donner.

Repere 2. Dans le cadre mise en production, le role ingenieur systeme doit relire les hypotheses relatives a Supervision, observabilite et capacite avant toute validation definitive. Pour le groupe dsi, la documentation associee a "Referentiel d'architecture technique et de supervision du SI hospitalier" rappelle que la qualite d'execution depend autant de la clarte des responsabilites que de la precision des informations transmises. Lorsque la situation change, la mise a jour doit etre horodatee, motivee et reliee a un indicateur de suivi tel que RPO respecte. Cette discipline documentaire permet de retrouver rapidement les passages utiles a une question RAG portant sur supervision, sur les arbitrages de terrain et sur les suites a donner.

Repere 3. Dans le cadre test de restauration, le role RSSI doit relire les hypotheses relatives a Sauvegardes, retention et restauration avant toute validation definitive. Pour le groupe dsi, la documentation associee a "Referentiel d'architecture technique et de supervision du SI hospitalier" rappelle que la qualite d'execution depend autant de la clarte des responsabilites que de la precision des informations transmises. Lorsque la situation change, la mise a jour doit etre horodatee, motivee et reliee a un indicateur de suivi tel que taux de patching. Cette discipline documentaire permet de retrouver rapidement les passages utiles a une question RAG portant sur sauvegardes, sur les arbitrages de terrain et sur les suites a donner.

Repere 4. Dans le cadre revue IAM, le role architecte SI doit relire les hypotheses relatives a IAM, habilitations et tracabilite avant toute validation definitive. Pour le groupe dsi, la documentation associee a "Referentiel d'architecture technique et de supervision du SI hospitalier" rappelle que la qualite d'execution depend autant de la clarte des responsabilites que de la precision des informations transmises. Lorsque la situation change, la mise a jour doit etre horodatee, motivee et reliee a un indicateur de suivi tel que delai moyen de resolution. Cette discipline documentaire permet de retrouver rapidement les passages utiles a une question RAG portant sur IAM, sur les arbitrages de terrain et sur les suites a donner.

Repere 5. Dans le cadre segmentation reseau, le role technicien support doit relire les hypotheses relatives a Gestion des incidents et escalade avant toute validation definitive. Pour le groupe dsi, la documentation associee a "Referentiel d'architecture technique et de supervision du SI hospitalier" rappelle que la qualite d'execution depend autant de la clarte des responsabilites que de la precision des informations transmises. Lorsque la situation change, la mise a jour doit etre horodatee, motivee et reliee a un indicateur de suivi tel que couverture de supervision. Cette discipline documentaire permet de retrouver rapidement les passages utiles a une question RAG portant sur segmentation reseau, sur les arbitrages de terrain et sur les suites a donner.
