...
export function RagQuestionPage() {
  ...
  const shouldShowAnswerCard = isQuerying || hasAnswer;
          ...
          <Card className="answer-card">
            <div className="answer-card__header">
              <div className="flex flex-col gap-2">
                ...
                <p className="m-0 text-sm text-ink-700">
                  La synthèse affichée ici s'appuie sur les documents autorisés
                  pour votre compte.
                </p>
              </div>
              ...
              >
                ...
                <span>
                  {isQuerying ? "Traitement backend" : "Réponse reçue"}
                </span>
              </span>
            </div>
            ...
            <div className="answer-card__body">
              {isQuerying ? (
                <div className="answer-card__loading-state">
                  <span
                    className="answer-card__loading-icon"
                    aria-hidden="true"
                  >
                    <FaGear className="answer-card__spinner" />
                  </span>
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="m-0 text-sm text-ink-700">
                      Le backend recherche les passages pertinents puis compose
                      la réponse.
                    </p>
                  </div>
                </div>
