...
function LoginPage({
  ...
  return (
    <div className="mx-auto grid min-h-screen w-[min(1200px,calc(100%-32px))] grid-cols-[minmax(0,1.1fr)_minmax(340px,420px)] gap-6 px-6 py-6 max-[920px]:grid-cols-1">
      <Panel as="section" className="p-8 max-[640px]:p-[18px]">
      ...
      <Panel
        as="form"
        className="p-8 max-[640px]:p-[18px]"
...
function DashboardLayout({
  ...
  const navigationItems: Array<{ to: string; label: string; icon: IconType }> =
    [
  ...
  return (
    <div className="grid min-h-screen grid-cols-[320px_minmax(0,1fr)] max-[1100px]:grid-cols-1">
      <aside className="flex flex-col gap-6 border-r border-stroke-softer bg-[linear-gradient(180deg,rgba(255,249,239,0.92),rgba(243,247,251,0.92))] p-7 max-[1100px]:border-r-0 max-[1100px]:border-b max-[1100px]:border-stroke-softer max-[640px]:p-[18px]">
        <div>
            ...
            <NavLink
              className={({ isActive }) =>
                [
                  ...
                  isActive
                    ? "bg-gradient-to-br from-brand-500 to-brand-600 text-white shadow-[0_14px_24px_rgba(216,95,61,0.18)]"
      ...
      <main className="p-6 max-[640px]:p-[18px]">
